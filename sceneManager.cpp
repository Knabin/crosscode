...
void sceneManager::init()
{
	...
	_tileImages[0] = IMAGEMANAGER->addFrameImage("terrain1 b", "images/tile/tile1_big.bmp", 768, 864, 16, 18, true, RGB(255, 0, 255));
	_tileImages[1] = IMAGEMANAGER->addFrameImage("terrain2 b", "images/tile/tile2_big.bmp", 768, 864, 16, 18, true, RGB(255, 0, 255));
	_tileImages[2] = IMAGEMANAGER->addFrameImage("terrain3 b", "images/tile/tile3_big.bmp", 768, 864, 16, 18, true, RGB(255, 0, 255));
}
