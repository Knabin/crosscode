		...
		case 0:
			...
			if (_vIv.size() != NULL)
			{
				...
				for (int i = 0; i < _vIv.size(); ++i)
				{
					...
					{
						itemObject it;
						it = _item->getItemInfo(L"¼Ò¸ð", _vIv[i].itemNum);

						IMAGEMANAGER->findImage("inven01")->render(Vector2(690 + 570 * (count % 2), 220 + 67 * (count / 2)));

						D2DRENDERER->RenderText(770 + 570 * (count % 2), 228 + 67 * (count / 2), it.itemName, 35, D2DRenderer::DefaultBrush::White, DWRITE_TEXT_ALIGNMENT_LEADING, L"¸¼Àº°íµñBold");
						wstring Num = to_wstring(_vIv[i].count);
						D2DRENDERER->RenderText(1150 + 570 * (count % 2), 228 + 67 * (count / 2), Num, 35, D2DRenderer::DefaultBrush::White, DWRITE_TEXT_ALIGNMENT_LEADING, L"¸¼Àº°íµñBold");
		...
		case 1:
			...
			if (_vIv.size() != NULL)
			{
				...
				for (int i = 0; i < _vIv.size(); ++i)
				{
					...
					{
						itemObject it;
						it = _item->getItemInfo(L"ÆÈ",_vIv[i].itemNum);
						...
						if (PtInRect(&rc.getRect(), _ptMouse))
						{
							...
							D2DRENDERER->RenderText(x, y, Num1, 35, D2DRenderer::DefaultBrush::White, DWRITE_TEXT_ALIGNMENT_LEADING, L"¸¼Àº°íµñBold");
							wstring Num2 = to_wstring(it.atk);
							D2DRENDERER->RenderText(x, y + d, Num2, 35, D2DRenderer::DefaultBrush::White, DWRITE_TEXT_ALIGNMENT_LEADING, L"¸¼Àº°íµñBold");
							wstring Num3 = to_wstring(it.def);
							D2DRENDERER->RenderText(x, y + d * 2, Num3, 35, D2DRenderer::DefaultBrush::White, DWRITE_TEXT_ALIGNMENT_LEADING, L"¸¼Àº°íµñBold");
							wstring Num4 = to_wstring(it.crt);
							D2DRENDERER->RenderText(x, y + d * 3, Num4, 35, D2DRenderer::DefaultBrush::White, DWRITE_TEXT_ALIGNMENT_LEADING, L"¸¼Àº°íµñBold");
							wstring Num5 = to_wstring(it.fireR);
							D2DRENDERER->RenderText(x, y + d * 4, Num5, 35, D2DRenderer::DefaultBrush::White, DWRITE_TEXT_ALIGNMENT_LEADING, L"¸¼Àº°íµñBold");
							wstring Num6 = to_wstring(it.iceR);
							D2DRENDERER->RenderText(x, y + d * 5, Num6, 35, D2DRenderer::DefaultBrush::White, DWRITE_TEXT_ALIGNMENT_LEADING, L"¸¼Àº°íµñBold");
							wstring Num7 = to_wstring(it.electricR);
							D2DRENDERER->RenderText(x, y + d * 6, Num7, 35, D2DRenderer::DefaultBrush::White, DWRITE_TEXT_ALIGNMENT_LEADING, L"¸¼Àº°íµñBold");
							wstring Num8 = to_wstring(it.psycoR);
							D2DRENDERER->RenderText(x, y + d * 7, Num8, 35, D2DRenderer::DefaultBrush::White, DWRITE_TEXT_ALIGNMENT_LEADING, L"¸¼Àº°íµñBold");
						}
		...
		case 2:
			...
			if (_vIv.size() != NULL)
			{
				...
				for (int i = 0; i < _vIv.size(); ++i)
				{
					...
					{
						itemObject it;
						it = _item->getItemInfo(L"¸Ó¸®", _vIv[i].itemNum);
		...
		case 3:
			...
			if (_vIv.size() != NULL)
			{
				...
				for (int i = 0; i < _vIv.size(); ++i)
				{
					...
					{
						itemObject it;
						it = _item->getItemInfo(L"¸öÅë", _vIv[i].itemNum);
		...
		case 4:
			...
			if (_vIv.size() != NULL)
			{
				...
				for (int i = 0; i < _vIv.size(); ++i)
				{
					...
					{
						itemObject it;
						it = _item->getItemInfo(L"´Ù¸®", _vIv[i].itemNum);
		...
		case 5:
			...
			if (_vIv.size() != NULL)
			{
				...
				for (int i = 0; i < _vIv.size(); ++i)
				{
					...
					{
						itemObject it;
						it = _item->getItemInfo(L"°Å·¡", _vIv[i].itemNum);
		...
		case 6:
			...
			if (_vIv.size() != NULL)
			{
				...
				for (int i = 0; i < _vIv.size(); ++i)
				{
					...
					{
						itemObject it;
						it = _item->getItemInfo(L"Áß¿ä", _vIv[i].itemNum);
