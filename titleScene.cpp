...
HRESULT titleScene::init()
{
	...
	btnStart->init("buttons", 300, 500, 0, 0, bind(&titleScene::cbStart, this));

	button* btnContinue = new button();
	btnContinue->init("buttons", 300, 600, 0, 1, bind(&titleScene::cbContinue, this));

	button* btnMaptool = new button();
	btnMaptool->init("buttons", 300, 700, 0, 2, bind(&titleScene::cbMaptool, this));

	button* btnOption = new button();
	btnOption->init("buttons", 300, 800, 0, 3, bind(&titleScene::cbOption, this));

	button* btnExit = new button();
	btnExit->init("buttons", 300, 900, 0, 4, bind(&titleScene::cbExit, this));
